...
use Doctrine\CommonPersistence\ObjectManager;
...
class ProduitController extends AbstractController
{
     ...
     */
    public function index(ProduitRepository $repos, ObjectManager $manager): Response
    {
     ...
     */
    public function fromulaire(Produit $produit = null, Request $request, ObjectManager $manager) 
    {
